...
import { ContentCarousel } from '@/components/Content-Carousel'; // Adjust the import path as necessary
...
export function Greview() {
  ...
  const reviews = [
    {
      id: "1",
      name: "Nevil Stephen",
      review: "Had a checkup for my Kid(3 year) here for dental cavity. Dr. Akshaya explained about the causes and mitigation very clearly. Dr. Rabina did the  pedio dental procedure to perfection. I’m glad I selected this place for dental checkup.",
      image: "https://lh3.googleusercontent.com/a-/ALV-UjWK_7Nd1-JPkDElwLK5W9VgThiuSGG7WiquNDLFwZGY69o0jdZIqw=w45-h45-p-rp-mo-ba3-br100",
      rating: 5
    },
    {
      id: "2",
      name: "Karthick Kumar Arunachalam",
      review: "Highly recommend! I have lots of anxiety about going to the dentist. After i visit, I get to know more about  RTC and doctors have explain various options that will best fit for my condition.They made me feel comfortable and helped with plain less RCT during and post treatment. I highly recommend this clinic for all my friends and family members...",
      image: "https://lh3.googleusercontent.com/a-/ALV-UjUe8QOtU8_G8ANIOektHPrxQJF5AxeWVuLczO_Gzz3MHSQSlvfatQ=w45-h45-p-rp-mo-br100",
      rating: 5
    },
    {
      id: "3",
      name: "Rajkumar NandaKumar",
      review: "We had an excellent experience with Dr. Akshaya. Treated for dental filling and root canal treatment for my daughter. The procedure was done with great care and minimal discomfort. The office is clean, modern, and well-equipped.",
      image: "https://lh3.googleusercontent.com/a-/ALV-UjVZs53oR3rSimXp4yWJHq463U2T7o8AO-L_iYwzbIBdhlxLfHn6Nw=w45-h45-p-rp-mo-br100",
      rating: 5
    },
  ];
  ...
  return (
    <section className="w-full max-w-7xl py-6 mx-auto">
      <Container>
        <div className="text-center mb-12">
          ...
          <div className="flex items-center justify-center space-x-2 mt-2 flex-wrap">
            ...
            <p className="text-gray-600 text-sm">4.9 rating from 250 reviews</p>
            <a
            ...
            >
              <button className="ml-4 mt-2 bg-blue-600 text-white px-4 py-2 rounded shadow hover:bg-blue-700 transition duration-200">
                Share Your Review
              </button>
            </a>
          </div>
        ...
        <div className="bg-white border border-gray-300 rounded-lg shadow-md p-5 mb-8">
          ...
          <div className='flex flex-col md:flex-row items-center justify-center gap-2'>
            <ContentCarousel
              ...
              autoPlay
              interval={3000}
              className="p-4 rounded mb-8 md:mb-0 md:w-1/2 w-full"
            />
            <ContentCarousel
