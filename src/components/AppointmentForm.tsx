    ...
    <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8 flex flex-col items-center text-center ">
      <form onSubmit={handleSubmit} className="flex flex-col items-center justify-center w-full">
        <div style={{ boxShadow: '4px 6px 0px 0px #047AA2' }} className="bg-white rounded-2xl p-4 md:p-6 w-full flex flex-col items-start ">
          ...
          <div className="flex flex-col md:flex-row w-full">
            <div className="md:flex-1 mb-6 md:mr-4">
              <label htmlFor="mobileNumber" className="text-gray-800 block text-sm font-medium mb-1 text-left">Mobile Number</label>
              <Input id="mobileNumber" name="mobileNumber" type="tel" placeholder="Enter your mobile number" value={formData.mobileNumber} onChange={handleChange} className="w-full" />
              {errors.mobileNumber && <p className="text-red-500 text-xs text-left">{errors.mobileNumber}</p>}
            </div>
            <div className="md:flex-1 mb-6 md:mr-4">
              <label htmlFor="appointment-date" className="text-gray-800 block text-sm font-medium mb-1 text-left">Preferred Visit Date</label>
              <div className="select-container">
                <Input id="appointment-date" name="appointmentDate" type="date" className="w-full text-[#6B7280] focus:text-black outline-none" value={formData.appointmentDate} onChange={handleChange} min={today} />
                {errors.appointmentDate && <p className="text-red-500 text-xs text-left">{errors.appointmentDate}</p>}
              </div>
